...
<body>
        ...
        <div class="container">
            ...
            <div id="navigation" class="collapse navbar-collapse">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a href="register.php" class="nav-link text-uppercase">SignUp</a></li>

                    <li class="nav-item"><a href="login.php" class="nav-link text-uppercase">Login</a></li>
        ...
        <div class="dark-overlay">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-7 pl-3">
                        ...
                        <div class="text-center">
                            <a href="#about" class="btn btn-primary text-white mb-4">Read More</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="more" class="bg-light my-5">
        <div class="container">
            <div class="row py-4">
                <div class="col-sm-12 col-md-7 border-right border-success pr-4">
